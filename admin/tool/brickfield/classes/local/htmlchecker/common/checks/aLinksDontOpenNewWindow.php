 ...
 */
class aLinksDontOpenNewWindow extends brickfield_accessibility_test
{
    ...
    /**
     *   public array $allowed_targets A list of targets allowed that don't open a new window
     */
