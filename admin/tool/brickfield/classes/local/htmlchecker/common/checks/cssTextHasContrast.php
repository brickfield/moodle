 ...
 */
class cssTextHasContrast extends brickfield_accessibility_color_test {
    /**
    ...
    /**
     * @var string $defaultbackground The default background color
     */
    public $defaultbackground = '#ffffff';

    /**
     * @var string $defaultcolor The default color
     */
