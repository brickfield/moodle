...
$string['content_not_analysed:mod_folder'] = 'Folder description analysed. Folder contents not analysed. Error count: {$a}';
$string['content_not_analysed:mod_h5pactivity'] = 'H5P content package description analysed. H5P content not analysed. Error count: {$a}';
$string['content_not_analysed:mod_imscp'] = 'IMS content package description analysed. IMS content not analysed. Error count: {$a}';
$string['content_not_analysed:mod_resource'] = 'File resource description analysed. File content not analysed. Error count: {$a}';
$string['content_not_analysed:mod_scorm'] = 'SCORM description analysed. SCORM content not analysed. Error count: {$a}';
